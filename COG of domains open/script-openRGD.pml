...
load open_RGD_Calpha.pdb

# Load the aligned trajectory
load_traj filtered_openRGD_control_aligned.dcd
...
split_states "open_RGD_Calpha", 1, 20001

# Generate mode vectors (porcupine plot) with specific visualization options
modevectors "open_RGD_Calpha_0001", "open_RGD_Calpha_0201", cutoff=0.0, head_length=2, head=0.4, headrgb=(1, 0.2, 0.1), tailrgb=(1, 0.2, 0.1), notail=0
...
cmd.enable('open_RGD_Calpha_0001', 1)
...
save open_RGDcontrol.pse, format=pse
