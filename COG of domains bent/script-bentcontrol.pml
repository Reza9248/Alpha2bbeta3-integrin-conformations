...
load bent_Calpha.pdb

# Load the aligned trajectory
load_traj filtered_bent_control_aligned.dcd
...
split_states "bent_Calpha", 1, 20001

# Generate mode vectors (porcupine plot) with specific visualization options
modevectors "bent_Calpha_0001", "bent_Calpha_0201", cutoff=0.0, head_length=2, head=0.4, headrgb=(1, 0.2, 0.1), tailrgb=(1, 0.2, 0.1), notail=0
...
save bent_control.pse, format=pse
